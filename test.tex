...
Let's cite a reference without any additional information: \jamkcite{einstein}

Let's cite a reference some additional information (e.g.\ page number): \jamkcite[p. 123]{einstein}
...
Let's reference our fine table:

Table~\ref{tbl:dicetypes} contains information about different kinds of dice!
